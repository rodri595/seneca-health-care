                            ...
                            <div className="row">
                                <div className="col-xl-8 mx-auto">
                                    <div className="section-title text-center mb-55">
                                        ...
                                        <h2 className="mb-15 wow fadeInUp" data-wow-delay=".4s">Our Healthcare Services</h2>
                                        <p className="wow fadeInUp" data-wow-delay=".6s">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
                                        dinonumy
							<br className="d-none d-lg-block" /> eirmod tempor invidunt ut labore et dolore magn.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
